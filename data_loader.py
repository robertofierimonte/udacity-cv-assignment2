...
def get_loader(transform, mode='train', 
               ...
               num_workers=0, 
               cocoapi_loc=Path(__file__).parents[1] / "cocoapi",
               subset_size=None):
    ...
    if mode == 'train':
        ...
        img_folder = cocoapi_loc / "images/train2014/"
        annotations_file = cocoapi_loc / "annotations/captions_train2014.json"
    elif mode == 'test':
        assert batch_size == 1, "Please change batch_size to 1 if testing your model."
        assert os.path.exists(vocab_file), "Must first generate vocab.pkl from training data."
        img_folder = cocoapi_loc / "images/test2014/"
        annotations_file = cocoapi_loc / "annotations/image_info_test2014.json"
